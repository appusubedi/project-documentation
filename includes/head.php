...
<head>
    ...
    <link rel="icon" href="img/banners/icon.svg" />
                ...
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <a class="navbar-brand" href="index.php">
                            <strong class="text-bold fs-2">StyleHub</strong>
                        </a>
                        ...
                        <div class="collapse navbar-collapse main-menu-item" id="navbarSupportedContent">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link fs-4" href="contact.php">About</a>
                                </li>
                                <li class="nav-item dropdown">
                                    <a class="nav-link fs-4" href="category.php">Products</a>
                                </li>
                            </ul>
                        </div>
                        <div class="hearer_icon d-flex">
                            ...
                            if (isset($_SESSION['email'])) {
                                ...
                                echo '<div class="nav-item">
                                        <a href="login.php"><button class="nav-link custom fs-4 text-bold">Login</button></a>
                                    </div>';
                                echo '<div class="nav-item">
                                        <a href="register.php"><button class="nav-link custom fs-4 text-bold">Sign Up</button></a>
                                    </div>';
                            }
