...
if (isset($_SESSION['email'])) {
    echo "<script> location.href='/mandala'; </script>";
    exit();
}
?>
            ...
            <div class="col-lg-6 col-md-6">
                <div class="login_part_text text-center">
                    <div class="login_part_text_iner">
                        ...
                        <p>
                            Create an account to immerse yourself in the world of fashion. Let's get started!
                        </p>
                    ...
                    <div class="login_part_form_iner">
                        ...
                        <form class="row contact_form" action="scripts/login_script.php" method="post" novalidate="novalidate">
                            ...
                            <div class="col-md-12 form-group">
                                ...
                                <a href="admin/login.php" class="mx-2 fs-6 text-decoration-none text-dark">Admin</a>
