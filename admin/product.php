            ...
            <form class="row g-3" action="manage/addproduct.php" method="POST">
                ...
                <div class="form-group col-md-6">
                    ...
                    <select id="category" name="category" class="form-control my-2">
                        ...
                        <option value="Short and Long Heels">Heels</option>
                        <option value="Blender and Makeup Products">Makeup</option>
                        <option value="Thick Puffer Jackets">Puffer Jackets</option>
                        <option value="Simple T-Shirts">Simple T-Shirts</option>
                        <option value="Hoodies">Hoodies</option>
                        <option value="Simple and Korean Earings">Earings</option>
