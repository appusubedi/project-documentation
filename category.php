            ...
            <div class="col-lg-8">
                <div class="breadcrumb_iner">
                    <div class="breadcrumb_iner_item">
                        ...
                        <h6> Designed for comfort without compromising on style <br> dress features.</h6>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        echo '<div class="col-lg-4 col-sm-6">
                                <div class="single_product_item">
                                    <img width="200px" height="300px" src="img/products/' . $row['image'] . '" alt="djwij" />
